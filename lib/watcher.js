...
function initPathWatcher() {
	try {
		logger.finest( "Looking for patchwatcher through normal require" );
	...
	try {
		logger.finest( "Looking for patchwatcher in '../precompiled_modules/" + getProcessPlatform() + "/" + getProcessArch() + "/pathwatcher'" );
